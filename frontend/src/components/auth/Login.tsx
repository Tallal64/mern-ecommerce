...
import type { userDataProps } from "@/types/products";
...
export default function LoginForm() {
  ...
  const onLoginClick = async () => {
    ...
    if (responseData?.success) {
      setIsLoading(true);
      toast({
        title: responseData?.message || "Login Successful",
        variant: "success",
      });
      setIsLoading(false);
    } else {
      toast({
        title: responseData?.error || "Invalid email or password",
        variant: "destructive",
      });
      setIsLoading(false);
    }
...
//         </CardContent>
//         <CardFooter className="flex flex-col">
//           <Button onClick={onLoginClick} className="w-full mb-4" size="lg">
//             Login
//           </Button>
//           <p className="text-sm text-center text-gray-600 dark:text-gray-400">
//             Don&apos;t have an account?{" "}
